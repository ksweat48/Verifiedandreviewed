...
const ReviewSubmissionForm = () => {
  ...
  if (!currentUser) {
    ...
    return {
      ...
      from: () => ({
        select: () => ({ eq: () => ({ single: () => Promise.resolve({ data: null, error: null }) }) }),
        insert: () => ({ select: () => ({ single: () => Promise.resolve({ data: null, error: { message: 'Supabase connection failed' } }) }) }),
        update: () => ({ eq: () => Promise.resolve({ data: null, error: { message: 'Supabase connection failed' } }) }),
        delete: () => ({ eq: () => Promise.resolve({ data: null, error: { message: 'Supabase connection failed' } }) })
      }),
      storage: {
        from: () => ({
          upload: () => Promise.resolve({ data: null, error: { message: 'Supabase connection failed' } }),
