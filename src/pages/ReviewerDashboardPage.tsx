...
const ReviewerDashboardPage = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      ...
      <button
        onClick={() => navigate('/')}
        className="fixed bottom-6 left-6 z-50 w-16 h-16 bg-gradient-to-r from-primary-500 to-accent-500 text-white rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 flex items-center justify-center group"
        title="Go to home page"
      >
        <Icons.Home className="h-6 w-6 group-hover:scale-110 transition-transform duration-200" />
      </button>
    </div>
  );
};
