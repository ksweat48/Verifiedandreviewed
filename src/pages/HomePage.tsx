...
const FeaturedBlogSection = lazy(() => import('../components/FeaturedBlogSection').then(module => ({ default: module.default })));
const ExploreArea = lazy(() => import('../components/ExploreArea').then(module => ({ default: module.default })));
const WeeklyReviewDigest = lazy(() => import('../components/WeeklyReviewDigest').then(module => ({ default: module.default })));
