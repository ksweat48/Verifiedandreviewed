      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="w-10 h-10 bg-primary-500 text-white rounded-full font-semibold hover:bg-primary-600 hover:scale-110 transition-all duration-200 flex items-center justify-center shadow-lg hover:shadow-xl"
            title="Add Business"
          >
