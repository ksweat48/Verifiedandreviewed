      ...
      >
        ...
        <div className="mb-6">
          ...
          <div className="flex gap-3 mb-3">
            ...
            {images.length < 3 && (
              <label className="w-20 h-20 border-2 border-dashed border-neutral-300 rounded-lg flex flex-col items-center justify-center cursor-pointer hover:border-primary-500 transition-colors duration-200">
