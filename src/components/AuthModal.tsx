  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 overflow-y-auto">
      <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl my-8 max-h-[90vh] overflow-y-auto">
        ...
        {mode === 'signup' && (
          <div className="mt-4 bg-primary-50 rounded-lg p-4 mb-2">
            ...
            <ul className="font-lora text-sm text-primary-700 space-y-1">
              ...
              <li>• 100 free credits every month</li>
              <li>• Earn credits for each review you submit</li>
              <li>• Earn 100 credits for each friend you refer</li>
