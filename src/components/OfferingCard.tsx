...
const OfferingCard: React.FC<{
  ...
  const handleBusinessClick = (e: React.MouseEvent) => {
    ...
    const businessForModal = {
      ...
      // Use the business image, not the offering image
      image_url: business.image_url || business.businesses?.image_url || '/verified and reviewed logo-coral copy copy.png',
