...
const OfferingCard: React.FC<{
  ...
  console.log(`🖼️ DEBUG: Business image sources in OfferingCard:`, {
    topLevelImage: business.image,
    topLevelImageUrl: business.image_url,
    businessImageUrl: business.business_image_url,
    nestedBusinessImageUrl: business.businesses?.image_url,
    nestedBusinesses: business.businesses ? 'Has nested businesses object' : 'No nested businesses object'
  });
  ...
  const handleBusinessClick = (e: React.MouseEvent) => {
    ...
    // Properly map the business data for the modal
    const businessForModal = {
      // Use the actual business ID and data from the nested businesses object
      ...
      short_description: business.business_short_description || business.short_description,
      address: business.address,
      location: business.location || business.address,
      // ALWAYS use the business image, never the offering image
      image_url: business.businesses?.image_url || business.business_image_url || '/verified and reviewed logo-coral copy copy.png',
      gallery_urls: business.gallery_urls || business.businesses?.gallery_urls || [],
      hours: business.hours || business.businesses?.hours || 'Hours not available',
      days_closed: business.days_closed || business.businesses?.days_closed,
      phone_number: business.phone_number || business.businesses?.phone_number,
      website_url: business.website_url || business.businesses?.website_url,
      ...
      tags: business.tags || business.businesses?.tags || [],
      is_verified: business.is_verified || business.businesses?.is_verified || business.isPlatformBusiness,
      ...
      is_mobile_business: business.is_mobile_business || business.businesses?.is_mobile_business,
      is_virtual: business.is_virtual || business.businesses?.is_virtual,
      latitude: business.latitude || business.businesses?.latitude,
      longitude: business.longitude || business.businesses?.longitude,
      created_at: business.created_at || business.businesses?.created_at,
      updated_at: business.updated_at || business.businesses?.updated_at
    };
    
    console.log(`🖼️ DEBUG: Business image mapping in handleBusinessClick:`, {
      originalBusinessImage: business.businesses?.image_url,
      businessImageUrl: business.business_image_url,
      finalImageUrl: businessForModal.image_url,
      businessId: businessForModal.id,
      businessName: businessForModal.name
    });
