...
}> = ({ business, onRecommend, onTakeMeThere, onOpenOfferingReviews, offeringReviewCounts, searchQueryText }) => {
    ...
    <>
      <div className="bg-neutral-50 rounded-lg p-3 border border-neutral-200 hover:shadow-sm transition-all duration-200" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="space-y-2">
          ...
          {/* Description */}
          {!business.isAIGenerated ? (
            (business.offeringDescription || business.description || business.short_description) && (
