...
import { MapPin, Calendar, User, ArrowRight, MessageCircle, ThumbsUp } from 'lucide-react';
import { mockRecentReviews } from '../data/mockData';

const RecentReviews = () => {
  const navigate = useNavigate();

  const recentReviews = mockRecentReviews;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="font-lora text-lg text-neutral-600 max-w-2xl mx-auto">
            Fresh insights from our community of reviewers sharing their latest experiences.
          </p>
        </div>
