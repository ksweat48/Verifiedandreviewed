            ...
            <div className="mb-6">
              ...
              {loading ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="font-lora text-neutral-600">No reviews found</p>
                </div>
              ) : (
                <div className="space-y-4">
                  {allReviews.map((review) => {
                    const businessName = review.offerings?.businesses?.name || review.businesses?.name || 'Unknown Business';
                    const offeringTitle = review.offerings?.title;
                    const displayName = offeringTitle ? `${offeringTitle} at ${businessName}` : businessName;
                      ...
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2 mb-2">
                            <span className={`px-2 py-1 rounded-full text-xs font-poppins font-semibold ${
                              review.is_visible ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
                            }`}>
                        ...
                        <div className="flex gap-2 ml-4">
                          <button
                            ...
                            className={`font-poppins px-3 py-1 rounded-lg text-sm font-semibold transition-colors duration-200 ${
                              review.is_visible 
