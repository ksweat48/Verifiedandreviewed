              ...
              if (placesResponse.data.status === 'OK' && placesResponse.data.results?.length > 0) {
                ...
                if (result) {
                  ...
                  return {
                    ...
                    short_description: `Highly-rated ${searchQuery}`,
                    business_description: `${result.name} is a highly-rated ${searchQuery} with ${result.rating} stars.`,
                    business_short_description: `Highly-rated ${searchQuery}`,
